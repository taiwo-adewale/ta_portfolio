...
const SocialMedia = () => {
  return (
    <div className='hidden sm:flex flex-col justify-end items-center p-4'>
      <a href='#' className='w-10 h-10 rounded-full bg-white my-1 border border-custLightGray flex-center transition-all duration-300 ease-in-out hover:bg-secondary hover:border-secondary group xxl:w-[70px] xxl:h-[70px] xxl:my-2'>
